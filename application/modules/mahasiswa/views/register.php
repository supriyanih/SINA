<div class="col-md-12">
    <div class="row">
        <div class="col-md-12 col-md-5">
            <legend><i class="glyphicon glyphicon-globe"></i>Tambah Mahasiswa</legend>
            <?php
            ...
            $data = array(
                ...
                'data-validation-error-msg' => 'Nim min 3 karakter'
            );
            ?>
        ...
        <div class="col-sm-2 col-md-6">
            <legend><i class="glyphicon glyphicon-globe"></i>Akademik</legend>
             <label for="">Jurusan</label>
              <?php echo form_dropdown('id_prodi', $prodi, '', 'class="form-control"'); ?>
              <label for="">Masukan Ke Kelas</label>
